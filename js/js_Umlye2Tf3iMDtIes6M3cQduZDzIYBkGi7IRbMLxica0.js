...
(function($, Drupal)
{
	Drupal.ajax.prototype.commands.afterAjaxCallbackAlventa = function(ajax, response, status)
	{
		if (response.selectedValue == 'seminar') {
			dataLayer.push({'event': 'sentsubseminar'});
		} else {
			dataLayer.push({'event': 'sentsubblog'});
		}
	};

	Drupal.ajax.prototype.commands.afterAjaxCallbackSubmitForm = function(ajax, response, status)
	{
		dataLayer.push({'event': 'sentform'});
	};

	Drupal.ajax.prototype.commands.afterAjaxCallbackSubmitSeminar = function(ajax, response, status)
	{
		dataLayer.push({'event': 'sentseminar'});
	};
